...
ORT_API_STATUS_IMPL(OrtSessionOptionsAppendExecutionProvider_Rknpu, _In_ OrtSessionOptions* options) {
  options->provider_factories.push_back(onnxruntime::CreateExecutionProviderFactory_Rknpu());
  return nullptr;
}
